...
public class CommentPath {
    ...
    public static CommentPath create(final String path) {
        if (isDepthOverflowed(path)) {
            throw new IllegalArgumentException("Comment depth cannot exceed " + MAX_DEPTH);
        }
    ...
    private static int calDepth(final String path) {
